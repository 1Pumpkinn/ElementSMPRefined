 ...
 * triggered by ID via {@link net.rose.elementSMPRefined.API.ElementApi#activateAbility(Player, String)}.
 * <p>
...
public class AbilityActivateEvent extends Event {
     ...
     * by ability ID through {@link net.rose.elementSMPRefined.API.ElementApi#activateAbility(Player, String)},
