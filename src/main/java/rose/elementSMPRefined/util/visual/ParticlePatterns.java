package rose.elementSMPRefined.util.visual;
...
public final class ParticlePatterns {
     ...
     */
    public static void animateExpandingRing(ExpandingRingConfig config, rose.elementSMPRefined.ElementSMPRefined plugin) {
    ...
    public static void animateRotatingCircle(CircleConfig config, long periodTicks,
                                             rose.elementSMPRefined.ElementSMPRefined plugin) {
        new org.bukkit.scheduler.BukkitRunnable() {
    ...
    public static class AnimationManager {
        ...
        private final rose.elementSMPRefined.ElementSMPRefined plugin;

        public AnimationManager(rose.elementSMPRefined.ElementSMPRefined plugin) {
            this.plugin = plugin;
        }
