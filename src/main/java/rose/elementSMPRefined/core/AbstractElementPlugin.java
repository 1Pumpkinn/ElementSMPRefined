package rose.elementSMPRefined.core;

import rose.elementSMPRefined.data.DataStore;
import rose.elementSMPRefined.addons.AddonManager;
import rose.elementSMPRefined.initializers.CommandInitializer;
import rose.elementSMPRefined.initializers.ListenerInitializer;
import rose.elementSMPRefined.initializers.RecipeInitializer;
import rose.elementSMPRefined.managers.*;
import rose.elementSMPRefined.services.EffectService;
import rose.elementSMPRefined.services.ValidationService;
import rose.elementSMPRefined.status.DisarmManager;
import rose.elementSMPRefined.status.StatusEffectManager;
import rose.elementSMPRefined.util.bukkit.MetadataHelper;
import rose.elementSMPRefined.util.scheduling.TaskScheduler;
...
public abstract class AbstractElementPlugin extends JavaPlugin {
    ...
    private void initializeManagers() {
        ...
        this.addonManager = new AddonManager((rose.elementSMPRefined.ElementSMPRefined) this);
        this.elementBotManager = new ElementBotManager((rose.elementSMPRefined.ElementSMPRefined) this);
    }
