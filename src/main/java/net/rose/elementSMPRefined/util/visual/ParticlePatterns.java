...
public final class ParticlePatterns {
    ...
    public static void animateRotatingCircle(CircleConfig config, long periodTicks,
                                             net.rose.elementSMPRefined.ElementSMPRefined plugin) {
        new org.bukkit.scheduler.BukkitRunnable() {
    ...
    public static class AnimationManager {
        ...
        private final net.rose.elementSMPRefined.ElementSMPRefined plugin;

        public AnimationManager(net.rose.elementSMPRefined.ElementSMPRefined plugin) {
            this.plugin = plugin;
        }
