package hs.elementSMPRefined.API.event;
 ...
 * triggered by ID via {@link hs.elementSMPRefined.API.ElementApi#activateAbility(Player, String)}.
 * <p>
...
public class AbilityActivateEvent extends Event {
     ...
     * by ability ID through {@link hs.elementSMPRefined.API.ElementApi#activateAbility(Player, String)},
